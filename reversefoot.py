...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=getMayaWindow()):
        ...
        uiFilePath = str(Path(__file__).parent.absolute()) + '/ui/revfootui.ui'
        ...
        self.ui.prefix_L.toggled.connect(lambda self=self: self.side='L')
        self.ui.prefix_R.toggled.connect(lambda self=self: self.side='R')
    ...
    def click_build(self):
        ...
        new_arm = rigfunctions.Limb(self.limb, self.names, 
                                    name=self.limb_name,
                                    side='R',
